...
import com.devabhi.currentlocation.Constants;
import com.devabhi.currentlocation.R;
import com.devabhi.currentlocation.dbase.DBHelper;
...
public class LocationService extends Service {
    ...
    private void saveLocation(String lat, String lng) {
        DBHelper dbHelper = new DBHelper(this);
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        dbHelper.saveToLocalDb(lat, lng, db);
        dbHelper.close();
    }
}
